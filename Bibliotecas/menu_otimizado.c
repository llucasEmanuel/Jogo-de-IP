...
int geraMenu(int *continuaMenu){
    
    int continua = 0; //variavel que a funcao vai retornar
    Texture BG;
    
    if(*continuaMenu == 0){ //carregar a textura apenas na primeira vez que rodar o programa
...
int iniciaJogo(int *continua_menu2){
    int flag = 0;
    int continua = 0; //variavel que a funcao retorna
    
    Texture w, s, a, d;
    
    if(*continua_menu2 == 0){ //carregar apenas na primeira vez que roda programa
